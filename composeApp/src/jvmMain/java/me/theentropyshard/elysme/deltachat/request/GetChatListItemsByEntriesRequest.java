...
public class GetChatListItemsByEntriesRequest extends RpcRequest {
    private int accountId;
    private int[] entries;

    public GetChatListItemsByEntriesRequest() {
        super(RpcMethod.get_chatlist_items_by_entries.name());
    }

    @Override
    public void prepare() {
        this.addParam(this.accountId);
        this.addParam(this.entries);
    }
