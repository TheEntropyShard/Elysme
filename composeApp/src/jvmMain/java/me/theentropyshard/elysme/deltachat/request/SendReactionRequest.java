...
public class SendReactionRequest extends RpcRequest {
    private int accountId;
    private int messageId;
    private String reaction;

    public SendReactionRequest() {
        super(RpcMethod.send_reaction.name());
    }

    @Override
    public void prepare() {
        this.addParam(this.accountId);
        this.addParam(this.messageId);
        this.addParam(new String[]{this.reaction});
    }
